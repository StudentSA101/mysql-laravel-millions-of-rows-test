...
class DeleteProduct extends Command
{
     ...
     * @var string
     */
    protected $description = 'Delete Database entries based on feed';
    ...
    public function handle()
    {
        try {
            ...
            $this->importer
                ->readFile(config('queries.sql.load_products_data_in_file'), env('TEST_PRODUCT_DELETE_FILE_PATH', env('CSV_FILE_LOCATION')))
                ->deleteRow();
